...
# Privacy-safe GRPO example launcher.
# - No hardcoded API keys
# - No private machine paths
# - Easy reward manager and reward kwargs switching
#
# Usage:
#   chmod +x examples/release/run_search_grpo_example.sh
...
#
# Optional:
#   ADV_ESTIMATOR=grpo | sgrpo
#   REWARD_MANAGER=naive | naive_llm | execution_reward | info_reward_llm
...
WANDB_EXPERIMENT_NAME="${WANDB_EXPERIMENT_NAME:-qwen7b-grpo-example}"
