...
class MultiTurnConfig(BaseConfig):
    ...
    max_tool_response_tokens: int = 500  # 新增：tool response的最大token数量
...
class RolloutConfig(BaseConfig):
    ...
    # Information Reward configuration for policy teacher mode
    info_reward_enabled: bool = False
    info_reward_use_policy_teacher: bool = False
    info_reward_ppl_threshold: float = 10.0
    info_reward_delta_phi_scale: float = 1.0
